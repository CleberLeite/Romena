...
import static com.frf.app.utils.TRACKING.clearToken;
import static com.frf.app.utils.UTILS.clearId;
...
/*    protected IvParameterSpec getIv() {
    ...
    public String getString(String key, String defaultValue) throws SecurePreferencesException {
        if (preferences.contains(key)) {
            //String securedEncodedValue = preferences.getString(key, defaultValue);
